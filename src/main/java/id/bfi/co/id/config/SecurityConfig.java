package id.bfi.co.id.config;

import javax.servlet.http.HttpServletResponse;

import id.bfi.co.id.auth.AuthenticationFilter;
import id.bfi.co.id.auth.SecurityContextService;
import id.bfi.co.id.constant.SecurityConstants.AuthenticationClaim;
